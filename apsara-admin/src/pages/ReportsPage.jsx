      ...
      <div className='bg-white rounded-[28px] sm:rounded-[40px] border border-green-50 shadow-sm p-5 sm:p-8 mb-7 sm:mb-10'>
        <div className='flex flex-col sm:flex-row sm:flex-wrap items-stretch sm:items-end gap-4 sm:gap-6'>
          ...
          <button onClick={() => setSubmitted(true)}
            className='w-full sm:w-auto bg-[#1B4332] text-white font-black px-8 sm:px-10 py-3.5 sm:py-4
                  ...
                  <thead className='bg-[#F2F7F2]/30'>
                    <tr>
                      {['ID','Customer','Revenue','Date'].map(h => (
                        <th key={h} className='text-left px-4 sm:px-8 py-3 sm:py-4 text-[9px] font-black text-emerald-900/40 uppercase tracking-widest'>{h}</th>
                      ))}
                    </tr>
                  </thead>
